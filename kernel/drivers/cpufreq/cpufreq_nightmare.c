...
#endif
#define POWERSUSPEND_HOTPLUGLOCK 1
...
static struct attribute *dbs_attributes[] = {
	...
	/* priority: hotplug_lock > max_cpu_lock > min_cpu_lock
	   Exception: hotplug_lock on power_suspend uses min_cpu_lock */
	&max_cpu_lock.attr,
	&min_cpu_lock.attr,
	&hotplug_lock.attr,
	&dvfs_debug.attr,
...
static void cpufreq_nightmare_power_suspend(struct power_suspend *h)
{
#if POWERSUSPEND_HOTPLUGLOCK
...
static void cpufreq_nightmare_power_resume(struct power_suspend *h)
{
#if POWERSUSPEND_HOTPLUGLOCK
...
#ifdef CONFIG_POWERSUSPEND
	power_suspend.suspend = cpufreq_nightmare_power_suspend;
	power_suspend.resume = cpufreq_nightmare_power_resume;
#endif
