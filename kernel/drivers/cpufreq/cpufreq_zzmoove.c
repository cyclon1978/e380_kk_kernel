...
static void powersave_power_suspend(struct power_suspend *handler)
{
...
static void powersave_power_resume(struct power_suspend *handler)
{
  mutex_lock(&dbs_mutex);
...
static struct power_suspend _powersave_power_suspend = {
  .suspend = powersave_power_suspend,
  .resume = powersave_power_resume,
};
				   ...
				   unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
        ...
        register_power_suspend(&_powersave_power_suspend);
		break;
	...
	case CPUFREQ_GOV_STOP:
        ...
        unregister_power_suspend(&_powersave_power_suspend);
		break;
