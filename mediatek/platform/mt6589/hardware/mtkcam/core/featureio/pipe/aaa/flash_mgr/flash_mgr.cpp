...
FlashMgr::FlashMgr()
{
	...
	m_bFocusScroll = 0;	//qiaoxiujun,ae/af control UI
...
//qiaoxiujun,ae/af control UI
void FlashMgr::setFocusScroll(int value) {		
	m_bFocusScroll = value;
}

int FlashMgr::getFocusScroll() {
	return m_bFocusScroll;
}
...
int FlashMgr::setFlashMode(int mode)
{
	...
	if(m_bFocusScroll == 1)	//qiaoxiujun,ae/af control UI
	{
		return 0;
	}
