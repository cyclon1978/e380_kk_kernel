...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/v1/hal/adapter/Arcsoft/Nightshot/inc
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/v1/hal/adapter/Arcsoft/Platform/inc

#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += #include <mtkcam/camshot/ISImager.h>
...
#-----------------------------------------------------------
LOCAL_MODULE := libcam.camadapter.scenario.shot.brightmagicshot
