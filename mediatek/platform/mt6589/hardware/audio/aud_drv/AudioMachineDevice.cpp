...
status_t AudioMachineDevice::AnalogCloseForSubSPK(AudioAnalogType::DEVICE_TYPE DeviceType)
{
    ...
    switch (DeviceType)
    {
        ...
        case AudioAnalogType::DEVICE_OUT_SPEAKERL:
            ...
            mAudioAnalogReg->SetAnalogReg(0x0702, 0x088f, 0x0fff);
            mAudioAnalogReg->SetAnalogReg(0x070c, 0x552, 0xffff); // Audio headset power on
...
//            mAudioAnalogReg->SetAnalogReg(0x0710, 0x0000, 0xffff);  // NCP on
            ...
            mAudioAnalogReg->SetAnalogReg(0x0714, 0x0d92, 0xffff); // short HS to vcm and HS output stability EnhanceParasNum
            ...
            mAudioAnalogReg->SetAnalogReg(0x071C, 0x64, 0xff);
            mAudioAnalogReg->SetAnalogReg(0x0738, 0x101, 0xfff);
            mAudioAnalogReg->SetAnalogReg(0x0746, 0x0000, 0xffff); // fix me
