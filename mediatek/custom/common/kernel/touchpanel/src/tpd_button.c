...
//	__set_bit(KEY_POWER, tpd->kpd->keybit);
//	__set_bit(KEY_PLAYPAUSE, tpd->kpd->keybit);
//	__set_bit(KEY_NEXTSONG, tpd->kpd->keybit);
//	__set_bit(KEY_PREVIOUSSONG, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_LEFT, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_RIGHT, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_UP, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_DOWN, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_DOUBLE_TAP, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_O, tpd->kpd->keybit);
	__set_bit(KEY_GESTURE_Z, tpd->kpd->keybit);
#endif
